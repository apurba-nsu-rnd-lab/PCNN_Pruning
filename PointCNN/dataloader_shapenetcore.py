...
if __name__ == '__main__':
    ...
    root= '/shafinSSD/Amrijit/BMVC_Models/PointCNN_ShapeNetCore/data'   # Rtx 3090
    ...
    train = Shapenet_Dataset(root=root, dataset_name=dataset_name, num_points=1024, split='trainval')
    test = Shapenet_Dataset(root=root, dataset_name=dataset_name, num_points=1024, split='test')

...
class Modelnet_Dataset(data.Dataset):
...
if __name__ == '__main__':
    ...
    train = Modelnet_Dataset(root=root, dataset_name=dataset_name, num_points=1024, split='trainval')
    test = Modelnet_Dataset(root=root, dataset_name=dataset_name, num_points=1024, split='test')

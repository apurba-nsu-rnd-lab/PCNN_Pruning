...
def load_scanobjectnn_data(partition):
    # BASE_DIR= "G:\Scanobject Dataset_h5_format"                           # Amrijit laptop
    BASE_DIR = '/shafinSSD/Amrijit/ScanObjectNN_Dataset'        # Rtx4090 machine
    # BASE_DIR= '/home/xavier/research/Amrijit/ScanObjectNN'                  # Rtx5000 machine
    all_data = []
    all_label = []

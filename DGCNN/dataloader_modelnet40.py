...
class Dataset_m40(data.Dataset):
    def __init__(self, root, dataset_name='modelnet40', class_choice=None,
        ...
        if dataset_name in ['shapenetcorev2', 'shapenetpart', 'shapenetpartpart','modelnet40']:
        ...
        if self.split in ['train', 'trainval', 'all']:   
            self.get_path('train')
        if self.dataset_name in ['shapenetcorev2', 'shapenetpart', 'shapenetpartpart','modelnet40']:
...
if __name__ == '__main__':
    #root = 'G:\ModelNet40 Dataset'  # <<<<<<< select root                                      # Amrijit laptop
    ...
    train = Dataset_m40(root=root, dataset_name=dataset_name, num_points=1024, split='trainval')
    test = Dataset_m40(root=root, dataset_name=dataset_name, num_points=1024, split='test')
